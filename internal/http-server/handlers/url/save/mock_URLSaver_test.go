...
func (_m *MockURLSaver) SaveURL(urlToSave string, alias string) (int64, error) {
...
func (_c *MockURLSaver_SaveURL_Call) Return(_a0 int64, _a1 error) *MockURLSaver_SaveURL_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockURLSaver_SaveURL_Call) RunAndReturn(run func(string, string) (int64, error)) *MockURLSaver_SaveURL_Call {
	_c.Call.Return(run)
	return _c
}
